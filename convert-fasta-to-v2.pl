...
#edit 06-01-18 to assign default PHRED33 quality of 30 -> (?)
#Alan E. Yocca
...
if (($err) || (!defined($seqfile)) || (!defined($lib))) {
...
#    }
#right here just need to make $qlt string of length $seq of just the quality string
